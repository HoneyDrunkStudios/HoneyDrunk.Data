...
- Bumped `HoneyDrunk.Vault.Providers.AzureKeyVault` `0.5.0 → 0.7.0`.
- Bumped `Microsoft.EntityFrameworkCore.Design` / `Microsoft.EntityFrameworkCore.SqlServer` `10.0.7 → 10.0.8`.
- Bumped `Microsoft.Extensions.DependencyInjection` `10.0.7 → 10.0.8`.
